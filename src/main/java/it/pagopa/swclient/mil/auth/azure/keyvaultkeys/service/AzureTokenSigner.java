		...
		return keyFinder.findValidPublicKeyWithGreatestExpiration()
			.chain(item -> {
				...
				try {
					...
					KeySignParameters req = new KeySignParameters(JWSAlgorithm.RS256.getName(), derDigestInfoBase64);
		...
		return authService.getAccessToken()
			...
			.chain(azureToken -> {
				try {
					...
					KeyVerifyParameters req = new KeyVerifyParameters(JWSAlgorithm.RS256.getName(), derDigestInfoBase64, signatureBase64);
