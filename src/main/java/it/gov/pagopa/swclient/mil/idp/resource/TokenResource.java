...
public class TokenResource {
	 ...
	 * @throws NotAuthorizedException
	 */
	private void verifyCredentials(ResourceOwnerCredentialsEntity credentialsEntity, String acquirerId, String channel,
	 ...
	 * @return
	 */
	private Uni<Optional<GrantEntity>> processGrants(String acquirerId, String channel, String merchantId,
					...
					try {
						...
						if (signatureOk) {
							...
							return Uni.createFrom()
									.failure(new InternalServerErrorException(Response.status(Status.UNAUTHORIZED)
						...
						return Uni.createFrom()
								.failure(new InternalServerErrorException(Response.status(Status.INTERNAL_SERVER_ERROR)
