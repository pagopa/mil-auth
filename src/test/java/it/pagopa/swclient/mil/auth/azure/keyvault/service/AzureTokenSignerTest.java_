...
class AzureTokenSignerTest {
	...
	/**
	 * Test method for
	 * {@link it.pagopa.swclient.mil.auth.azure.keyvault.service.AzureTokenSigner#sign(com.nimbusds.jwt.JWTClaimsSet)}.
	 *
	...
	/**
	 * Test method for
	 * {@link it.pagopa.swclient.mil.auth.azure.keyvault.service.AzureTokenSigner#verify(com.nimbusds.jwt.SignedJWT)}.
	 *
	 * @throws JOSEException
	 */
	@Test
