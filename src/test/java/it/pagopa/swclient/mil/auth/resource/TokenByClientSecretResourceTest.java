...
class TokenByClientSecretResourceTest {
	 ...
	 * 
	 * 
	 * @Test void testProcessWithClientVerifierThrowsAuthException() { when(verifier.verify(anyString(),
	 * anyString(), anyString())) .thenReturn(Uni.createFrom().failure(new AuthException("0",
	 * "synthetic exception")));
	 * 
	 * GetAccessTokenRequest request = new GetAccessTokenRequest(
	 * "00000000-0000-0000-0000-000000000001", VERSION, CLIENT_ID, ACQUIRER_ID, CHANNEL, MERCHANT_ID,
	 * TERMINAL_ID, GRANT_TYPE, null, null, null, null, CLIENT_ID, null, SECRET);
	 * 
	 * service.process(request) .subscribe() .withSubscriber(UniAssertSubscriber.create())
	 * .assertFailedWith(AuthException.class); }
	 * 
	 * @Test void testProcessWithClientVerifierThrowsAuthError() { when(verifier.verify(anyString(),
	 * anyString(), anyString())) .thenReturn(Uni.createFrom().failure(new AuthError("0",
	 * "synthetic exception")));
	 * 
	 * GetAccessTokenRequest request = new GetAccessTokenRequest(
	 * "00000000-0000-0000-0000-000000000002", VERSION, CLIENT_ID, ACQUIRER_ID, CHANNEL, MERCHANT_ID,
	 * TERMINAL_ID, GRANT_TYPE, null, null, null, null, CLIENT_ID, null, SECRET);
	 * 
	 * service.process(request) .subscribe() .withSubscriber(UniAssertSubscriber.create())
	 * .assertFailedWith(AuthError.class); }
	 * 
	 * @Test void testProcessWithClientVerifierThrowsAnotherException() {
	 * when(verifier.verify(anyString(), anyString(), anyString()))
	 * .thenReturn(Uni.createFrom().failure(new Exception("synthetic exception")));
	 * 
	 * GetAccessTokenRequest request = new GetAccessTokenRequest(
	 * "00000000-0000-0000-0000-000000000003", VERSION, CLIENT_ID, ACQUIRER_ID, CHANNEL, MERCHANT_ID,
	 * TERMINAL_ID, GRANT_TYPE, null, null, null, null, CLIENT_ID, null, SECRET);
	 * 
	 * service.process(request) .subscribe() .withSubscriber(UniAssertSubscriber.create())
