...
class TokenInfoResourceTest {
	...
	void given_badToken_when_tokeInfoIsInvoked_then_getBadRequest() {
		...
		given()
			...
			.formParam(FormParamName.TOKEN, "1.1.1")
			.when()
			.post()
			.then()
			.log()
