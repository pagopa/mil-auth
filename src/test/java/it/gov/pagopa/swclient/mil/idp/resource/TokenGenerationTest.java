...
public class TokenGenerationTest {
	 ...
	 * 
	 * // Prepare request GetAccessToken getAccessToken = new GetAccessToken(); CommonHeader
	 * commonHeader = new CommonHeader(); String clientId = "5254f087-1214-45cd-94ae-fda53c835197";
	 * String channel = "POS"; String username = "antonio.tarricone"; String password = "antonio";
	 * String merchantId = "28405fHfk73x88D"; String acquirerId = "01234568909"; String terminalId =
	 * "testTerm"; getAccessToken.setClientId(clientId); commonHeader.setChannel(channel);
	 * getAccessToken.setUsername(username); getAccessToken.setPassword(username);
	 * getAccessToken.setScope("offline_access"); commonHeader.setMerchantId(merchantId);
	 * commonHeader.setAcquirerId(acquirerId); commonHeader.setTerminalId(terminalId);
	 * RequestSpecification request = given() .contentType(MediaType.APPLICATION_FORM_URLENCODED)
	 * .formParam("client_id", clientId) .formParam("username", username) .formParam("password",
	 * password) .formParam("grant_type", "password") .header("AcquirerId", acquirerId)
	 * .header("TerminalId", terminalId) .header("MerchantId", merchantId) .header("RequestId",
	 ...
	 * bit more, checking if the type is correct Uni<AccessToken> Log.info(resp.body());
	 * 
	 ...
	 * 
	 * // Prepare request GetAccessToken getAccessToken = new GetAccessToken(); CommonHeader
	 * commonHeader = new CommonHeader(); String clientId = "5254f087-1214-45cd-94ae-fda53c835198";
	 * String channel = "POS"; String username = "antonio.tarricone"; String password = "antonio";
	 * String merchantId = "28405fHfk73x88D"; String acquirerId = "01234568909"; String terminalId =
	 * "testTerm"; getAccessToken.setClientId(clientId); commonHeader.setChannel(channel);
	 * getAccessToken.setUsername(username); getAccessToken.setPassword(username);
	 * getAccessToken.setScope("offline_access"); commonHeader.setMerchantId(merchantId);
	 * commonHeader.setAcquirerId(acquirerId); commonHeader.setTerminalId(terminalId);
	 * RequestSpecification wrongClientIdRequest = given()
	 * .contentType(MediaType.APPLICATION_FORM_URLENCODED) .formParam("client_id", clientId)
	 * .formParam("username", username) .formParam("password", password) .formParam("grant_type",
	 * "password") .header("AcquirerId", acquirerId) .header("TerminalId", terminalId)
	 ...
	 * // Prepare request GetAccessToken getAccessToken = new GetAccessToken(); CommonHeader
	 * commonHeader = new CommonHeader(); String clientId = "5254f087-1214-45cd-94ae-fda53c835197";
	 * String channel = "TOTEM"; String username = "antonio.tarricone"; String password = "antonio";
	 * String merchantId = "28405fHfk73x88D"; String acquirerId = "01234568909"; String terminalId =
	 * "testTerm"; getAccessToken.setClientId(clientId); commonHeader.setChannel(channel);
	 * getAccessToken.setUsername(username); getAccessToken.setPassword(username);
	 * getAccessToken.setScope("offline_access"); commonHeader.setMerchantId(merchantId);
	 ...
	 * Assert.assertTrue(responseMessage.get(0).equals(ErrorCode. ERROR_WHILE_FINDING_GRANTS)); }
	 * 
	 ...
	 * // Prepare request GetAccessToken getAccessToken = new GetAccessToken(); CommonHeader
	 * commonHeader = new CommonHeader(); String clientId = "5254f087-1214-45cd-94ae-fda53c835197";
	 * String channel = "POS"; String username = "antonio.t"; String password = "antonio"; String
	 * merchantId = "28405fHfk73x88D"; String acquirerId = "01234568909"; String terminalId =
	 * "testTerm"; getAccessToken.setClientId(clientId); commonHeader.setChannel(channel);
	 * getAccessToken.setUsername(username); getAccessToken.setPassword(username);
	 * getAccessToken.setScope("offline_access"); commonHeader.setMerchantId(merchantId);
	 * commonHeader.setAcquirerId(acquirerId); commonHeader.setTerminalId(terminalId);
	 ...
	 * commonHeader = new CommonHeader(); String clientId = "5254f087-1214-45cd-94ae-fda53c835197";
	 * String channel = "POS"; String username = "antonio.tarricone"; String password = "antonio";
	 * String merchantId = "28405fHfk73x88E"; String acquirerId = "01234568909"; String terminalId =
	 * "testTerm"; getAccessToken.setClientId(clientId); commonHeader.setChannel(channel);
	 * getAccessToken.setUsername(username); getAccessToken.setPassword(username);
	 * getAccessToken.setScope("offline_access"); commonHeader.setMerchantId(merchantId);
	 * commonHeader.setAcquirerId(acquirerId); commonHeader.setTerminalId(terminalId);
